  ...
  suite_start "19 — Smoke Test Abilities"                                                                                                                                                      
  ...
  SAMPLE_JSON='{"timestamp":"2026-03-29T12:00:00Z","server":"http://localhost","environment":"test","summary":{"total":2,"passed":1,"failed":1},"results":[{"name":"Home","url":"/","status":"P
  ASS","httpCode":200,"errors":[]},{"name":"Admin","url":"/admin","status":"FAIL","httpCode":200,"errors":["ORA-00904"]}]}'                                                                    
