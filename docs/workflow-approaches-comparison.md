...
> **Status (2026-09-25):** snapshot of the 2026-04-02 analysis, kept for the reasoning behind #200. The first roadmap step (extracting a shared `core/lib/cc-workflow.sh`) has not been implemented, so read the roadmap as a proposal, not as the current state.
...
| Enterprise features (SSO, LDAP, audit) | N/A | N/A | N/A | **Paid license required** (see n8n for current pricing) |
